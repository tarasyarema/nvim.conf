...
" nnoremap <silent> <space>a  :<C-u>CocList diagnostics
" Manage extensions.
" nnoremap <silent> <space>e  :<C-u>CocList extensions
" Show commands.
" nnoremap <silent> <space>c  :<C-u>CocList commands
" Find symbol of current document.
" nnoremap <silent> <space>o  :<C-u>CocList outline
" Search workspace symbols.
" nnoremap <silent> <space>s  :<C-u>CocList -I symbols
" Do default action for next item.
" nnoremap <silent> <space>j  :<C-u>CocNext
" Do default action for previous item.
" nnoremap <silent> <space>k  :<C-u>CocPrev
" Resume latest coc list.
" nnoremap <silent> <space>p  :<C-u>CocListResume
